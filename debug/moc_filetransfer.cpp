...
QT_MOC_LITERAL(1, 13, 9), // "beginning"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 8), // "finished"
QT_MOC_LITERAL(4, 33, 5), // "error"
QT_MOC_LITERAL(5, 39, 4), // "code"
QT_MOC_LITERAL(6, 44, 4), // "beat"
QT_MOC_LITERAL(7, 49, 5) // "begin"

    },
    "FileTransfer\0beginning\0\0finished\0error\0"
    "code\0beat\0begin"
};
...
void FileTransfer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FileTransfer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileTransfer::beginning)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (FileTransfer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileTransfer::finished)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (FileTransfer::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileTransfer::error)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (FileTransfer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileTransfer::beat)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 2
void FileTransfer::error(QString _t1)
{
