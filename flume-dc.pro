...
TARGET = "flume-dc"
TEMPLATE = app
INCLUDEPATH += "$$(HOMEPATH)\Documents\GitHub\libssh2\include"
LIBPATH += "$$(HOMEPATH)\Documents\GitHub\libssh2\src\Debug"
LIBPATH += "$$(HOMEPATH)\Downloads\openssl-build\OpenSSL_1_0_1h-install-msvc1800-64\Debug\lib"
